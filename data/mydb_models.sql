...
CREATE TABLE `models` (
  ...
  CONSTRAINT `fk_id_company_models` FOREIGN KEY (`id_company`) REFERENCES `companies` (`id_company`)
...
INSERT INTO `models` VALUES (1,1,'CA4','av'),(2,1,'M24','av'),(3,2,'K45','av'),(4,1,'O2','av'),(5,2,'T1K','av');
